var WorkerThread = (function (exports) {
  ...
  /* Initializing */
  ;
  var set$1 = function set(newPhase) {
  ...
  function () {
    ...
    _proto.mutationCompleteHandler_ = function mutationCompleteHandler_(value) {
      var oldValue = this.storeAttributeMethod_(this.element_.namespaceURI, 'style', value);
      mutate({
        type: 0
        /* ATTRIBUTES */
        ,
  ...
  function (_Node) {
    ...
    function Element(nodeType, nodeName, namespaceURI) {
      ...
      _this.localName = toLower(nodeName);
      _this._transferredFormat_ = (_this$_transferredFor = {}, _this$_transferredFor[7
      /* _index_ */
      ] = _this._index_, _this$_transferredFor[8
      /* transferred */
    ...
    _proto.querySelectorAll = function querySelectorAll(selector) {
      ...
      var matches = null; //As per spec: https://dom.spec.whatwg.org/#scope-match-a-selectors-string
      ...
      if (selector[0] === '#') {
        matches = matchChildrenElements(this.ownerDocument.documentElement, function (element) {
      ...
      if (matches) {
        return matches.filter(function (element) {
          return _this2.contains(element) && _this2 !== element;
        });
  ...
  */
  ...
  function (_Element) {
    ...
    function SVGElement(nodeType, nodeName) {
      var _this;

      _this = _Element.call(this, nodeType, nodeName, SVG_NAMESPACE) || this;
      _this.localName = nodeName;
      return _this;
    }
  ...
  /*#__PURE__*/
  function (_CharacterData) {
    _inheritsLoose(Comment, _CharacterData);
    ...
    function Comment(data) {
      ...
      _this = _CharacterData.call(this, data, 8
      /* COMMENT_NODE */
      , '#comment') || this;
      _this._transferredFormat_ = (_this$_transferredFor = {}, _this$_transferredFor[7
      /* _index_ */
      ...
      /* FALSE */
      8, _this$_creationFormat[1
      /* nodeName */
      ] = store$1('#comment'), _this$_creationFormat[5
      /* textContent */
      ] = store$1(_this.data), _this$_creationFormat);
      return _this;
    }
  ...
  function (_Element) {
    ...
    function Document() {
      ...
      _this.createComment = function (text) {
        return new Comment(text);
      };

      _this.observe = function () {
        observe(_assertThisInitialized(_assertThisInitialized(_this)), _this.postMessageMethod);
        propagate$1();
        propagate$2();
      };
  ...
  function consumeInitialDOM(document, strings, hydrateableNode) {
    strings.forEach(function (string) {
      return store$1(string);
    });
    (hydrateableNode[4
    /* childNodes */
    ] || []).forEach(function (child) {
      return document.body.appendChild(create(document, strings, child));
    });
    set$1(1
    /* Hydrating */
    );
  ...
  function create(document, strings, skeleton) {
    ...
    /* nodeType */
      ...
      /* TEXT_NODE */
      :
        var text = document.createTextNode(strings[skeleton[5
        /* textContent */
        ]]);
        store(text);
        return text;
      ...
      /* COMMENT_NODE */
      :
        var comment = document.createComment(strings[skeleton[5
        /* textContent */
        ]]);
        store(comment);
        return comment;
      ...
      default:
        ...
        var nodeName = strings[skeleton[1
        /* nodeName */
        ]];
        var node = namespace ? document.createElementNS(namespace, nodeName) : document.createElement(nodeName);
        (skeleton[2
        /* attributes */
        ] || []).forEach(function (attribute) {
          var namespaceURI = strings[attribute[0]];
        ...
        /* childNodes */
          ...
          return node.appendChild(create(document, strings, child));
        });
        return node;
    }
  }
  ...
  var workerDOM = {
    ...
    consumeInitialDOM: consumeInitialDOM,
...
//# sourceMappingURL=unminified.worker.js.map
